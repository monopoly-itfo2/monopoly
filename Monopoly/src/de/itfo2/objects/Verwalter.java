...
//                    spieler.get(spielerAmZug).setPlatz(2);
    ...
    public void checkIfHypothekVerfuegbar(boolean critical){
        ...
        if(verfuegbar){
            ...
            if(critical){
                gui.addLogMessage(getCurSpieler().getName() + " Du hast keine Grundst¸cke f¸r Hypotheken." );
...
//    	spielfeld.ereigniskarten.remove(0);
    	...
    	switch(typ) {//Das Problem ist, das die Variablen aus dem Falschem Array gelˆscht werden
	    	case 0:
