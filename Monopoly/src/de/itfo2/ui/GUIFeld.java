...
public class GUIFeld extends PicturePanel implements Observer {
	...
	public void init() throws IOException {
		...
		BufferedImage img = ImageIO.read(getClass().getResource(
				"/de/itfo2/ui/resources/hausTransparent.jpg"));
		...
		img = ImageIO.read(getClass().getResource(
				"/de/itfo2/ui/resources/hotelTransparent.jpg"));
		...
		img = ImageIO.read(getClass().getResource(
				"/de/itfo2/ui/resources/hypothek.png"));
		...
		image = ImageIO.read(this.getClass().getResource(
				"/de/itfo2/ui/resources/figur_green.png"));
		ImageIcon spielfigur = new ImageIcon(ColorChanger.changeColor(image,
				Color.WHITE, Color.getHSBColor(0.9f, 0.1f, 0.7f)));
		...
		image = ImageIO.read(this.getClass().getResource(
				"/de/itfo2/ui/resources/figur_red.png"));
		spielfigur = new ImageIcon(ColorChanger.changeColor(image, Color.WHITE,
				Color.getHSBColor(0.9f, 0.1f, 0.7f)));
		...
		image = ImageIO.read(this.getClass().getResource(
				"/de/itfo2/ui/resources/figur_template.png"));
		spielfigur = new ImageIcon(ColorChanger.changeColor(image, Color.WHITE,
				Color.RED));
		...
		if (feld instanceof Grundstueck) {
			...
			labelPreis = new JLabel(((Freiparken) feld).getSumme()
					+ "€ im Pott");
			labelPreis.setBounds(0, 30, 90, 10);
			labelPreis.setOpaque(false);
			labelPreis.setFont(new Font("Calibri", 0, 10));
	...
	public void faerbeFeld(Color color) {
		this.setBackgroundImage(ColorChanger.changeColor(
				(BufferedImage) getImage(), Color.WHITE, color));
	}
